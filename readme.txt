=== The Events Calendar Extension: Day View Plain Language URLs ===
...
The Events Calendar's Day View: Add today +/- number of days type of URLs.

== Description ==

The Events Calendar's Day View already supports the `/events/today/` URL. This extension extends this to add "plain language" URLs like `/events/today/1` and `/events/today/-1`.
